...
export default function PaginaEventos() {
  return (
    <div className="grid grid-cols-3 gap-5 ">
      {eventos.map((evento) => (
        <div className="flex flex-col bg-zinc-800 rounded-lg overflow-hidden" key={evento.id}>
          ...
          <div className="flex-1 flex flex-col items-center p-7 gap-5 text-center">
            ...
            <QRCode className="w-44 h-44" value={JSON.stringify({ id: evento.id, senha: evento.senha })} />
